...
router.get('/session/:sessionId/client-profile', requireRole('asesor', 'admin'), getClientProfile);
router.get('/client/:clientId/profile', requireRole('asesor', 'admin'), getClientProfileByClientId);
