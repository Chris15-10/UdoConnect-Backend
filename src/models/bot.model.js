...
export class BotModel {
  ...
  static async crearSesion(idCliente) {
    try {
      // Auto-asignar al asesor con menos sesiones activas (máx 5)
      const idAsesor = await getAvailableAsesor();

      await db.execute(
        "INSERT INTO sesiones (id_cliente, flujo_actual, ultimo_paso_bot, estado, id_asesor) VALUES ($1, 'principal', 'inicio', 'activa_bot', $2)",
        [idCliente, idAsesor]
      );
