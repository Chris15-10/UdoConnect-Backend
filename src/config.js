...
export const ALLOWED_ORIGINS = [
    ...
    "http://localhost:5174", // Vite - puerto alternativo cuando 5173 está ocupado
    "http://localhost:5175", // Vite - puerto alternativo extra
    "https://udoconnectfrontend.vercel.app", // Frontend en producción
];
